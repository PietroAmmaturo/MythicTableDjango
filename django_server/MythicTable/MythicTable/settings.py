"""
Django settings for MythicTable project.
...
WSGI_APPLICATION = 'MythicTable.wsgi.application'
...
# REMINDER
# django-oidc prende il token dal provider (MythicTable...)
# djangorest_simplejwt si deve occupare di gestire l'autenticazione ogni volta che l'user invia una richiesta
